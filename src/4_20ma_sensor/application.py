...
from .app_ui import 420maSensorUI
from .app_state import 420maSensorState

log = logging.getLogger()

class 420maSensorApplication(Application):
    config: 420maSensorConfig  # not necessary, but helps your IDE provide autocomplete!

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        self.started: float = time.time()
        self.ui: 420maSensorUI = None
        self.state: 420maSensorState = None

    async def setup(self):
        self.ui = 420maSensorUI()
        self.state = 420maSensorState()
